...
- **料金**: 先着5名様限定 19,800円(税込)(通常価格29,800円)。`.price-card__amount--soon` クラスは現在未使用
...
- **料金表示**: 正式な料金が決定し、`Coming Soon` から実際の金額に差し替え済み。「先着5名様」ラベル+通常価格29,800円(税込)→19,800円(税込)のキャンペーン表示(`.price-card__old` で取り消し線)
...
ヘッダー(ロゴのみ)→ ヒーロー(記事タイトル+CTA)→ なぜこの記事を書いたか → 作り手の想い(手元写真付き)→ CTAバナー → フッター
...
- ヒーローはドライフラワー・アンティーク雑貨・ラテアートの温かみのあるフラットレイ写真を背景に、下部をアイボリーへ滑らかにグラデーションさせて本文セクションへ繋げている
...
| 用途 | ファイル |
|---|---|
| ヒーロー背景(フラットレイ) | `assets/hero-flatlay.jpg` |
